...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2018 at 09:45 AM
...
CREATE TABLE `data_nasabah` (
  ...
  `no.tlp_nasbah` varchar(50) NOT NULL
...
--
ALTER TABLE `data_nasabah`
  MODIFY `id_nasabah` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pinjaman`
--
ALTER TABLE `pinjaman`
  MODIFY `id_nasabah` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pinjaman`
  ADD CONSTRAINT `pinjaman_ibfk_1` FOREIGN KEY (`id_nasabah`) REFERENCES `data_nasabah` (`id_nasabah`);

--
-- Constraints for table `simpanan`
--
ALTER TABLE `simpanan`
  ADD CONSTRAINT `simpanan_ibfk_1` FOREIGN KEY (`id_nasabah`) REFERENCES `data_nasabah` (`id_nasabah`);
COMMIT;
